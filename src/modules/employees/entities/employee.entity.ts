...
// closure-table và self-referencing là 2 loại phổ biến nhất, materialized-path cũng được đánh giá cao, nested-set hơi khó hiểu và khó dùng (chỉ có 1 root duy nhất nữa)
@Entity()
